...
`)}function Yp(r,t){let e;switch(t){case lh:e="Linear";break;case hh:e="Reinhard";break;case uh:e="Cineon";break;case Xc:e="ACESFilmic";break;case fh:e="AgX";break;case ph:e="Neutral";break;case dh:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Xs=new G;function jp(){qt.getLuminanceCoefficients(Xs);const r=Xs.x.toFixed(4),t=Xs.y.toFixed(4),e=Xs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function $p(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ms).join(`
...
#define LOW_PRECISION`),t}function im(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Hc?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Wc?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Ln&&(t="SHADOWMAP_TYPE_VSM"),t}function sm(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Yi:case ji:t="ENVMAP_TYPE_CUBE";break;case fr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function rm(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case ji:t="ENVMAP_MODE_REFRACTION";break}return t}function om(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case qc:t="ENVMAP_BLENDING_MULTIPLY";break;case ah:t="ENVMAP_BLENDING_MIX";break;case ch:t="ENVMAP_BLENDING_ADD";break}return t}function am(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function cm(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=im(e),l=sm(e),h=rm(e),d=om(e),u=am(e),f=$p(e),g=Kp(s),_=i.createProgram();let m,p,v=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(ms).join(`
`)),o=qo(o),o=cc(o,e),o=lc(o,e),a=qo(a),a=cc(a,e),a=lc(a,e),o=hc(o),a=hc(a),e.isRawShaderMaterial!==!0&&(v=`#version 300 es
...
`)+`
`+p);const S=v+m+o,x=v+p+a,L=rc(i,i.VERTEX_SHADER,S),T=rc(i,i.FRAGMENT_SHADER,x);i.attachShader(_,L),i.attachShader(_,T),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(C){if(r.debug.checkShaderErrors){const U=i.getProgramInfoLog(_).trim(),A=i.getShaderInfoLog(L).trim(),D=i.getShaderInfoLog(T).trim();let F=!0,N=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(F=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,L,T);else{const q=ac(i,L,"vertex"),B=ac(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
